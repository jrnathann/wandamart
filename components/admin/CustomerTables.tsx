      ...
      <div className="relative -mx-4 sm:mx-0 overflow-x-auto">
        <table className="w-full min-w-[640px]">
          <thead className="bg-gradient-to-r from-shopici-blue/10 via-shopici-coral/5 to-shopici-blue/10 border-b-2 border-shopici-charcoal/10">
            <tr>
              <th className="px-3 py-2 sm:px-4 sm:py-3 lg:px-6 lg:py-4 text-left text-[10px] sm:text-xs font-bold uppercase tracking-wider text-shopici-charcoal dark:text-shopici-gray">
                Client
              </th>
              <th className="px-3 py-2 sm:px-4 lg:px-6 text-left text-[10px] sm:text-xs font-bold uppercase tracking-wider text-shopici-charcoal dark:text-shopici-gray">
                Contact
              </th>
              <th className="hidden md:table-cell px-3 py-2 sm:px-4 lg:px-6 text-left text-[10px] sm:text-xs font-bold uppercase tracking-wider text-shopici-charcoal dark:text-shopici-gray">
                Zone
              </th>
              <th className="px-3 py-2 sm:px-4 lg:px-6 text-center text-[10px] sm:text-xs font-bold uppercase tracking-wider text-shopici-charcoal dark:text-shopici-gray">
                Cmd
              </th>
              <th className="hidden sm:table-cell px-3 py-2 sm:px-4 lg:px-6 text-right text-[10px] sm:text-xs font-bold uppercase tracking-wider text-shopici-charcoal dark:text-shopici-gray">
                Total
              </th>
              <th className="hidden lg:table-cell px-3 py-2 sm:px-4 lg:px-6 text-right text-[10px] sm:text-xs font-bold uppercase tracking-wider text-shopici-charcoal dark:text-shopici-gray">
                Dernière
              </th>
            </tr>
          </thead>
            ...
            {currentCustomers.map((customer) => (
              ...
              >
                ...
                <td className="px-3 py-2 sm:px-4 sm:py-3 lg:px-6 lg:py-4">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="leading-tight">
                      <p className="font-semibold text-sm sm:text-base text-shopici-black dark:text-shopici-foreground">
                        {customer.name}
                      </p>
                      <p className="text-[10px] sm:text-xs text-shopici-charcoal dark:text-shopici-gray">
                ...
                <td className="px-3 py-2 sm:px-4 lg:px-6">
                  <div className="space-y-0.5 sm:space-y-1 text-[11px] sm:text-sm text-shopici-charcoal dark:text-shopici-gray">
        ...
        <div className="border-t-2 border-shopici-charcoal/10 bg-gradient-to-r from-shopici-coral/5 via-transparent to-shopici-blue/5 px-4 sm:px-6 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 text-sm">
              <span className="font-semibold text-shopici-charcoal dark:text-shopici-gray whitespace-nowrap">
                Lignes par page:
              </span>
              <select
                value={itemsPerPage}
                onChange={(e) => handleItemsPerPageChange(Number(e.target.value))}
                className="px-3 py-2 border-2 border-shopici-charcoal/10 rounded-lg bg-white dark:bg-shopici-charcoal/50 text-shopici-black dark:text-shopici-foreground font-semibold text-sm focus:outline-none focus:ring-2 focus:ring-shopici-coral/30 transition-all"
              >
                {ITEMS_PER_PAGE_OPTIONS.map(option => (
                  <option key={option} value={option}>{option}</option>
                ))}
              </select>
              <span className="text-shopici-charcoal dark:text-shopici-gray whitespace-nowrap">
